...
// Pin to kommotity fork until siderolabs repo is merged
...
replace github.com/siderolabs/cluster-api-control-plane-provider-talos => github.com/kommodity-io/cluster-api-control-plane-provider-talos v0.5.12-0.20250919101334-fc8e752b256a
