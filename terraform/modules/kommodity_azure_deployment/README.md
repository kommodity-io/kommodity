...
|------|-------------|------|---------|:--------:|
| <a name="input_database"></a> [database](#input\_database) | Database configuration | <pre>object({<br/>    storage_tier                  = optional(string, "P4")<br/>    sku_name                      = optional(string, "B_Standard_B1ms")<br/>    storage_mb                    = optional(number, 32768)<br/>    version                       = optional(string, "15")<br/>    public_network_access_enabled = optional(bool, false)<br/>    ha_enabled                    = optional(bool, false)<br/>    storage_georedundant_enabled  = optional(bool, false)<br/>    collation                     = optional(string, "en_US.utf8")<br/>  })</pre> | `{}` | no |
