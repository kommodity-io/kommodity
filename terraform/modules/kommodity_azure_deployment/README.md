...
| <a name="input_nat_gateway"></a> [nat\_gateway](#input\_nat\_gateway) | NAT gateway for stable Container App outbound IP. Attach to container subnet. | <pre>object({<br/>    enabled      = optional(bool, false)<br/>    idle_timeout = optional(number, 30)<br/>    zone         = optional(string, "1")<br/>  })</pre> | `{}` | no |
