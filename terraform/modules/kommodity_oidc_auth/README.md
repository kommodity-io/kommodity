...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_azure_ad_application"></a> [azure\_ad\_application](#input\_azure\_ad\_application) | Azure AD application configuration | <pre>object({<br/>    name                           = optional(string, "kommodity-oidc-app")<br/>    sign_in_audience               = optional(string, "AzureADMyOrg")<br/>    group_membership_claims        = optional(list(string), ["SecurityGroup"])<br/>    requested_access_token_version = optional(number)<br/>  })</pre> | `{}` | no |
