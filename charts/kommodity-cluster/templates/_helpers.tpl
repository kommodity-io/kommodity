...
{{- else -}}
{{- fail "no Talos image configured for Azure: set talos.imageName (recommended) together with kommodity.provider.config.subscriptionID to build the Talos image resource ID, or use talos.id / talos.computeGallery / talos.marketplace" -}}
{{- end -}}
{{- end -}}
